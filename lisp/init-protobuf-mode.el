;;; init-protobuf-mode.el --- protobuf-mode configuration. -*- lexical-binding: t -*-
...
;;; Code:
(defcustom se/use-protobuf-mode nil
  "Option to use the protobuf-mode package."
  :type 'boolean
  :group 'selenemacs)

(when se/use-protobuf-mode
